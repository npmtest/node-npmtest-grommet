...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/icons/status/CriticalStatus.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/icons/status/CriticalStatus.js</span></h1>
    <h2>
        
        Statements: <span class="metric">61.97% <small>(44 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/icons/status/</a> &#187; CriticalStatus.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function CriticalStatus() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, CriticalStatus);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (CriticalStatus.__proto__ || Object.getPrototypeOf(CriticalStatus)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _classnames2.default)(CLASS_ROOT, CLASS_ROOT + '-critical', className);</span>
      // generate an id to avoid duplication in the DOM
<span class="cstat-no" title="statement not covered" >      var maskId = 'mask-critical-' + _lastId++;</span>
