...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/icons/base/AccessAssistListening.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/icons/base/AccessAssistListening.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/icons/base/</a> &#187; AccessAssistListening.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _classnames3.default)(CLASS_ROOT, CLASS_ROOT + '-access-assist-listening', className, (_classnames = {}, _defineProperty(_classnames, CLASS_ROOT + '--' + size, size), _defineProperty(_classnames, CLASS_ROOT + '--responsive', responsive), _defineProperty(_classnames, COLOR_INDEX + '-' + colorIndex, colorIndex), _classnames));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      a11yTitle = a11yTitle || _Intl2.default.getMessage(intl, 'access-assist-listening');</span>
&nbsp;
