...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/App.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/App.js</span></h1>
    <h2>
        
        Statements: <span class="metric">60% <small>(57 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">39.62% <small>(21 / 53)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">50% <small>(8 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">75% <small>(39 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/</a> &#187; App.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (!localesSupported()) {
  require('intl');
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function App(props, context) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, App);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, props, context));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var lang = this.props.lang || (0, _Locale.getCurrentLocale)();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!document.documentElement.getAttribute('lang')) {</span>
<span class="cstat-no" title="statement not covered" >        document.documentElement.setAttribute('lang', lang);</span>
      }
<span class="cstat-no" title="statement not covered" >      this.setState({ lang: lang });</span>
    }
  }, {
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var lang = this.state.lang;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _classnames3.default)('grommet', CLASS_ROOT, (_classnames = {}, _defineProperty(_classnames, CLASS_ROOT + '--centered', centered), _defineProperty(_classnames, CLASS_ROOT + '--inline', inline), _classnames), className);</span>
&nbsp;
