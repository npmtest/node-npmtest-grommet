...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/video/PlayButton.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/video/PlayButton.js</span></h1>
    <h2>
        
        Statements: <span class="metric">75.36% <small>(52 / 69)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">77.27% <small>(34 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/video/</a> &#187; PlayButton.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PlayButton() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PlayButton);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (PlayButton.__proto__ || Object.getPrototypeOf(PlayButton)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var PIcon = primary ? _CirclePlay2.default : _Play2.default;</span>
<span class="cstat-no" title="statement not covered" >      var Icon = playing ? _Pause2.default : ended ? _Refresh2.default : PIcon;</span>
<span class="cstat-no" title="statement not covered" >      var controlIcon = _react2.default.createElement(Icon, { className: BUTTON_CLASS + '__icon', size: iconSize,</span>
        colorIndex: 'brand' });
&nbsp;
<span class="cstat-no" title="statement not covered" >      var a11yControlButtonMessage = playing ? 'Pause Video' : ended ? 'Restart Video' : 'Play Video';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var a11yControlButtonTitle = _Intl2.default.getMessage(intl, a11yControlButtonMessage);</span>
&nbsp;
