...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/video/Overlay.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/video/Overlay.js</span></h1>
    <h2>
        
        Statements: <span class="metric">64.29% <small>(45 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/video/</a> &#187; Overlay.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Overlay(props, context) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Overlay);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Overlay.__proto__ || Object.getPrototypeOf(Overlay)).call(this, props, context));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (newProps.size !== this.props.size) {</span>
...
<span class="cstat-no" title="statement not covered" >        this.setState({ iconSize: 'medium' });</span>
      } else {
<span class="cstat-no" title="statement not covered" >        var iconSize = 'small' === this.props.size ? undefined : 'xlarge';</span>
<span class="cstat-no" title="statement not covered" >        this.setState({ iconSize: iconSize });</span>
      }
    }
  }, {
    key: '_renderReplayMenu',
    value: <span class="fstat-no" title="function not covered" >function _renderReplayMenu() {</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var replayContent = void 0;</span>
<span class="cstat-no" title="statement not covered" >      if (ended) {</span>
<span class="cstat-no" title="statement not covered" >        replayContent = _react2.default.createElement(</span>
          _Box2.default,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return replayContent;</span>
    }
  }, {
    key: 'render',
