...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/ListItem.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/ListItem.js</span></h1>
    <h2>
        
        Statements: <span class="metric">66.2% <small>(47 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/</a> &#187; ListItem.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ListItem);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (ListItem.__proto__ || Object.getPrototypeOf(ListItem)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _classnames3.default)(CLASS_ROOT, className, _defineProperty({}, CLASS_ROOT + '--selectable', onClick));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var restProps = _Props2.default.omit(this.props, Object.keys(ListItem.propTypes));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        _Box2.default,
        _extends({}, boxProps, restProps, { tag: 'li', className: classes }),
        children
      );
    }
  }]);
...
;
&nbsp;
ListItem.propTypes = _extends({}, _Box2.default.propTypes);
&nbsp;
