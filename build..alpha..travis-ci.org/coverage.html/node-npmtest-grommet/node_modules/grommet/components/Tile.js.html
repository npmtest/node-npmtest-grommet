...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/Tile.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/Tile.js</span></h1>
    <h2>
        
        Statements: <span class="metric">64% <small>(48 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/</a> &#187; Tile.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Tile);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Tile.__proto__ || Object.getPrototypeOf(Tile)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Tile, [{
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var restProps = _Props2.default.omit(this.props, Object.keys(Tile.propTypes));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var statusClass = status ? status.toLowerCase() : undefined;</span>
      // if Tiles flush is true, default borderSize to small (1px)
<span class="cstat-no" title="statement not covered" >      var borderSize = hoverBorder ? hoverBorderSize ? hoverBorderSize : 'large' : 'small';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _classnames3.default)(CLASS_ROOT, className, (_classnames = {}, _defineProperty(_classnames, CLASS_ROOT + '--status-' + statusClass, status), _defineProperty(_classnames, CLASS_ROOT + '--wide', wide), _defineProperty(_classnames, CLASS_ROOT + '--selectable', onClick), _defineProperty(_classnames, '' + NAMESPACE + hoverStyle + (hoverStyle == 'border' ? borderSize ? '-' + borderSize : '-medium' : '') + '-hover-color-index-' + hoverColorIndex, hoverStyle), _defineProperty(_classnames, CLASS_ROOT + '--hover-border-' + borderSize, borderSize), _classnames));</span>
&nbsp;
