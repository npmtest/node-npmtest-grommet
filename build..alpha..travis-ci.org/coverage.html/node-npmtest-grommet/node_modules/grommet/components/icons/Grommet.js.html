...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/icons/Grommet.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/icons/Grommet.js</span></h1>
    <h2>
        
        Statements: <span class="metric">70.31% <small>(45 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/icons/</a> &#187; Grommet.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Grommet() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Grommet);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Grommet.__proto__ || Object.getPrototypeOf(Grommet)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _classnames3.default)(CLASS_ROOT, (_classnames = {}, _defineProperty(_classnames, CLASS_ROOT + '--small', small), _defineProperty(_classnames, CLASS_ROOT + '--large', large), _defineProperty(_classnames, CLASS_ROOT + '--' + size, size), _classnames), className);</span>
<span class="cstat-no" title="statement not covered" >      var stroke = invert ? '#fff' : '#865CD6';</span>
