...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/Object.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/Object.js</span></h1>
    <h2>
        
        Statements: <span class="metric">53.33% <small>(40 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/</a> &#187; Object.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function GrommetObject() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, GrommetObject);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (GrommetObject.__proto__ || Object.getPrototypeOf(GrommetObject)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(GrommetObject, [{
    key: '_renderArray',
    value: <span class="fstat-no" title="function not covered" >function _renderArray(array) {</span>
<span class="cstat-no" title="statement not covered" >      return array.map(<span class="fstat-no" title="function not covered" >function (item, index) {</span></span>
<span class="cstat-no" title="statement not covered" >        var itemContent = item;</span>
<span class="cstat-no" title="statement not covered" >        if ('object' === (typeof item === 'undefined' ? 'undefined' : _typeof(item))) {</span>
<span class="cstat-no" title="statement not covered" >          itemContent = this._renderObject(item);</span>
        }
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement(</span>
    ...
    key: '_renderObject',
    value: <span class="fstat-no" title="function not covered" >function _renderObject(obj) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (obj.hasOwnProperty(name)) {</span>
<span class="cstat-no" title="statement not covered" >          var value = obj[name];</span>
<span class="cstat-no" title="statement not covered" >          var classes = [CLASS_ROOT + "__attribute"];</span>
<span class="cstat-no" title="statement not covered" >          if (null === value) {</span>
<span class="cstat-no" title="statement not covered" >            value = 'null';</span>
<span class="cstat-no" title="statement not covered" >            classes.push(CLASS_ROOT + "__attribute--unset");</span>
          } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >            var items = this._renderArray(value);</span>
<span class="cstat-no" title="statement not covered" >            value = _react2.default.createElement(</span>
              'ol',
              null,
              items
            );
<span class="cstat-no" title="statement not covered" >            classes.push(CLASS_ROOT + "__attribute--array");</span>
          } else <span class="cstat-no" title="statement not covered" >if ('object' === (typeof value === 'undefined' ? 'undefined' : _typeof(value))) {</span>
<span class="cstat-no" title="statement not covered" >            value = this._renderObject(value);</span>
<span class="cstat-no" title="statement not covered" >            classes.push(CLASS_ROOT + "__attribute--container");</span>
          } else {
<span class="cstat-no" title="statement not covered" >            value = value.toString();</span>
          }
<span class="cstat-no" title="statement not covered" >          attrs.push(_react2.default.createElement(</span>
            'li',
