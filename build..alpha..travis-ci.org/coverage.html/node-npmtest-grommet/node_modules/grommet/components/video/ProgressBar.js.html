...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/video/ProgressBar.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/video/ProgressBar.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/video/</a> &#187; ProgressBar.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ProgressBar() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ProgressBar);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (ProgressBar.__proto__ || Object.getPrototypeOf(ProgressBar)).call(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this._onProgressBarChange = _this._onProgressBarChange.bind(_this);</span>
...
<span class="cstat-no" title="statement not covered" >      return this.props.progress !== nextProps.progress;</span>
    }
  }, {
    key: '_onProgressBarChange',
    value: <span class="fstat-no" title="function not covered" >function _onProgressBarChange(e) {</span>
<span class="cstat-no" title="statement not covered" >      this.props.onChange(e.target.value * this.props.duration / 100);</span>
    }
  }, {
    key: '_onChapterClick',
    value: <span class="fstat-no" title="function not covered" >function _onChapterClick(time) {</span>
<span class="cstat-no" title="statement not covered" >      this.props.onChange(time);</span>
    }
  }, {
    key: '_onMouseOver',
    value: <span class="fstat-no" title="function not covered" >function _onMouseOver(index) {</span>
<span class="cstat-no" title="statement not covered" >      this.props.onChapterHover(index);</span>
    }
  }, {
    key: '_renderChapterMarkers',
    value: <span class="fstat-no" title="function not covered" >function _renderChapterMarkers() {</span>
...
<span class="cstat-no" title="statement not covered" >        var chapters = timeline.map(<span class="fstat-no" title="function not covered" >function (chapter, index, chapters) {</span></span>
<span class="cstat-no" title="statement not covered" >          var percent = chapter.time / duration * 100;</span>
<span class="cstat-no" title="statement not covered" >          var tickClasses = (0, _classnames3.default)(CLASS_ROOT + '__chapter-marker-tick', _defineProperty({}, CLASS_ROOT + '__chapter-marker-tick-start', percent === 0));</span>
&nbsp;
