...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grommet/node_modules/grommet/components/video/Share.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grommet/node_modules/grommet/components/video/Share.js</span></h1>
    <h2>
        
        Statements: <span class="metric">72.06% <small>(49 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">72.09% <small>(31 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grommet/node_modules/grommet/components/video/</a> &#187; Share.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Overlay() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Overlay);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Overlay.__proto__ || Object.getPrototypeOf(Overlay)).call(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this._onClickShareLink = _this._onClickShareLink.bind(_this);</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  _createClass(Overlay, [{
    key: '_onClickShareLink',
    value: <span class="fstat-no" title="function not covered" >function _onClickShareLink() {</span>
<span class="cstat-no" title="statement not covered" >      (0, _reactDom.findDOMNode)(this.shareLinkRef).select();</span>
    }
  }, {
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var shareContent = null;</span>
<span class="cstat-no" title="statement not covered" >      if (shareLink) {</span>
<span class="cstat-no" title="statement not covered" >        shareContent = _react2.default.createElement(</span>
          _Box2.default,
          { align: 'center' },
...
<span class="cstat-no" title="statement not covered" >                  return _this2.shareLinkRef = _ref;</span>
                },
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return shareContent;</span>
    }
  }]);
&nbsp;
  return Overlay;
